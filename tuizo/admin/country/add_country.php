...
if (isset($_POST['submit'])) {
	...
	$CheckCountry = mysqli_query($con,"SELECT * FROM countries WHERE country_name='$country'");
    ...
    if ($country == "") {
		...
		$err = "Country Name already exist";
	} else {
        ...
        $AddCountrySql = "INSERT INTO countries SET $AddCountry";
                ...
                <div class="widget first">
                    ...
                    <div class="body">
                        <div class="charts" style="width: 700px; height: auto;">
                            <form action="add_country.php" method="post" class="mainForm">
                                ...
                                <fieldset>
                                    <div class="widget first">
                                        ...
                                        <div class="rowElem noborder"><label>Country Name:</label><div class="formRight">                                         <input name="country" type="text" value="<?php echo $country; ?>"/>
                                                    </div><div class="fix"></div></div>

                                        <div class="rowElem noborder"><label>Status:</label><div class="formRight">
                                                    <input name="status" type="checkbox" value="allow"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="position:relative; top:5px;">Allow</span>
                                                   </div><div class="fix"></div></div>

                                        
                                        <input type="submit" name="submit" value="Add Country" class="greyishBtn submitForm" />
                                        <div class="fix"></div>
