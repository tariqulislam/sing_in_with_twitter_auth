                  ...
                  <h5 class="iFrames">Country List</h5></div>
                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                      <thead>
                        ...
                        <tbody>
<?php
$SqlCountry = mysqli_query($con,"SELECT * FROM countries");
while($GetCountry = mysqli_fetch_array($SqlCountry))
{
?>                        
                          ...
                          <tr class="gradeA">
                                ...
                                <td><?php echo $GetCountry['country_status']; ?></td>
                            	<td><?php
								$adminid = $GetCountry['country_updated_by'];
								$adminsql = mysqli_query($con,"SELECT (admin_full_name) FROM admins WHERE admin_id='$adminid'");
								$adminrow = mysqli_fetch_array($adminsql);
								echo $adminrow[0];
								?></td>
                                <td class="center"><a href="edit_country.php?cid=<?php echo base64_encode($GetCountry['country_id']); ?>" title="Edit"><img src="<?php echo baseUrl('admin/images/pencil-grey-icon.png')?>" height="14" width="14" alt="Edit" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<!--<a href="javascript:del(<?php echo $GetCountry['TC_id']; ?>);"><img src="../images/delete.png" /></a>--></td>
                          </tr>
<?php
}
?>
