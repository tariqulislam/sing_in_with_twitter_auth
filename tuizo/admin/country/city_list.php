                  ...
                  <h5 class="iFrames">Country List</h5></div>
                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                      <thead>
                        ...
                        <tbody>
<?php
$SqlCity = mysqli_query($con,"SELECT * FROM cities");
 mysqli_num_rows($SqlCity);
while($GetCity = mysqli_fetch_assoc($SqlCity))

{
?>                        
                        
                          <tr class="gradeA">
                                <td><?php echo $GetCity['city_id']; ?></td>
                                <td>
								<?php 
								$cid = $GetCity['city_country_id']; 
                                ...
                                <td><?php echo $GetCity['city_status']; ?></td>
                            	<td><?php
								$adminid = $GetCity['city_updated_by'];
								$adminsql = mysqli_query($con,"SELECT (admin_full_name) FROM admins WHERE admin_id='$adminid'");
								$adminrow = mysqli_fetch_array($adminsql);
								echo $adminrow[0];
								?></td>
                                <td class="center"><a href="edit_city.php?cid=<?php echo base64_encode($GetCity['city_id']); ?>" title="Edit"><img src="<?php echo baseUrl('admin/images/pencil-grey-icon.png')?>" height="14" width="14" alt="Edit" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<!--<a href="javascript:del(<?php echo $GetCity['city_id']; ?>);"><img src="../images/delete.png" /></a>--></td>
                          </tr>
<?php
}
?>
