...
?>                        
                          ...
                          <tr class="gradeA">
								...
								echo $adminrow[0];
								?></td>
                                <td class="center"><a href="edit/index.php?pid=<?php echo base64_encode($prorow['product_id']); ?>" title="Edit"><img src="<?php echo baseUrl('admin/images/pencil-grey-icon.png')?>" height="14" width="14" alt="Edit" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<!--<a href="javascript:del(<?php echo $taxrow['TC_id']; ?>);"><img src="../images/delete.png" /></a>--></td>
                          </tr>
<?php
}
?>
