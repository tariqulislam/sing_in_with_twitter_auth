    ...
    <body>
        ...
        <div class="wrapper">
          ...
          <?php include ('order_left_navigation.php'); ?>
            ...
            <!-- Content Start -->
            <div class="content">
                <div class="title"><h5>All Order Lists</h5></div>
...
if(@$_GET['order_status'] == ''){
	$BookingOrderSql = mysqli_query($con,"SELECT * FROM orders");
} else {
	$status = $_GET['order_status'];
	$BookingOrderSql = mysqli_query($con,"SELECT * FROM orders WHERE order_status='$status'");
}
...
?>                        
                          ...
                          <tr class="gradeA">
								...
								?></td>
                                <td><?php echo $GetBookingOrder['order_number']; ?></td>
                                <td><?php echo date('d-M-Y h.i.s A',strtotime($GetBookingOrder['order_created'])); ?></td>
                                <td><?php echo $GetBookingOrder['order_shipping_city']; ?></td>
                            	<!--<td><?php
								...
								echo $adminrow[0];
								?></td>-->
                                <td class="center"><a href="order_details.php?oid=<?php echo base64_encode($GetBookingOrder['order_id']); ?>" title="Edit"><img src="<?php echo baseUrl('admin/images/pencil-grey-icon.png')?>" height="14" width="14" alt="Edit" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<!--<a href="javascript:del(<?php echo $taxrow['TC_id']; ?>);"><img src="../images/delete.png" /></a>--></td>
                          </tr>
<?php
}
?>
