                  ...
                  <h5 class="iFrames">Customer Review List</h5></div>
                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                      <thead>
                        ...
                        <tbody>
<?php
$SqlRating = mysqli_query($con,"SELECT * FROM product_rating ORDER BY PR_id");
while($GetRating = mysqli_fetch_array($SqlRating))
{
?>                        
                        
                          <tr class="gradeA">
                                <td><?php 
								$proid = $GetRating['PR_product_id'];
								...
								?></td>
                                <td><?php echo $GetRating['PR_rating_amount']; ?></td>
